...
const simpanData = async () => {
  try {
    ...
    // Kita berikan custom message khusus untuk c_jam_id agar bahasanya lebih "manusiawi"
    handlePBError(error, {
      c_jam_id: {
        validation_not_unique: `Gagal! ID Jam "${form.value.c_jam_id}" sudah ada di database.`,
      },
    })
  }
}
